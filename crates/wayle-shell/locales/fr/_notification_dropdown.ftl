...
notification-dropdown-history = Historique
notification-dropdown-history-empty-title = Aucun historique
notification-dropdown-history-empty-description = Les notifications ignorées apparaîtront ici
